...
export class NestLogger implements LoggerService {
    ...
    log(message: any, ...optionalParams: any[]) {
        console.log(
            colours.black,
            colours.green,
            ...this._format('info', message, optionalParams),
        );
    }
    ...
    error(message: any, ...optionalParams: any[]) {
        ...
        console.error(
            colours.black,
            colours.red,
            ...this._format('error', e, optionalParams),
        );
    }
    ...
    warn(message: any, ...optionalParams: any[]) {
        if (this.logLevel >= levels.warn)
            console.warn(
                colours.black,
                colours.yellow,
                ...this._format('warn', message, optionalParams),
            );
    }
    ...
    debug?(message: any, ...optionalParams: any[]) {
        if (this.logLevel >= levels.debug)
            console.debug(
                colours.black,
                colours.blue,
                ...this._format('debug', message, optionalParams),
            );
    }
    ...
    verbose(message: any, ...optionalParams: any[]) {
        if (this.logLevel >= levels.verbose)
            console.log(
                colours.black,
                colours.magenta,
                ...this._format('verbose', message, optionalParams),
            );
    }
