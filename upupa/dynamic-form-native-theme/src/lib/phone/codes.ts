import { ClientDataSource, DataAdapter } from "@upupa/table";
...
const codes = allCountries.map(c => {
    return {
        name: c[0].toString(),
        iso2: c[1].toString(),
...
export const adapter = new DataAdapter(new ClientDataSource(codes), 'dialCode', 'name')