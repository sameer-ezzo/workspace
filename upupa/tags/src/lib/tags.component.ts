...
export class TagsComponent implements OnInit {
    ...
    nodeActions: any[] = [{ name: 'add', icon: 'add', text: 'add' }, { name: 'edit', icon: 'edit', text: 'edit' }, { name: 'remove', icon: 'clear', text: 'remove' }];
    ...
    private async editTag(data: any) {
        const res = await firstValueFrom(this.dialog.open(TagFormComponent, {
