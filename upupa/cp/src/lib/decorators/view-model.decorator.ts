...
export type TableViewModelOptions = {

}
export function TableViewModel( options: TableViewModelOptions = {}) {
...
export function scaffolder(path: string, options: ViewMetaOptions & ModelSchemeRouteOptions = {}) {
    return function (target) {
        ...
        // }
        if (options.listView !== null) TableViewModel(path, { /*...listMeta,*/ ...opts.listView })(target)
