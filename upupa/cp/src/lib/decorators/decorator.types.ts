...
import { IScaffolder, ListScaffoldingModel, DataListFilterForm, FormScaffoldingModel } from '../../types';
...
export type ListViewModelOptions = Partial<Omit<any, 'filterForm' | 'query' | 'queryParams'>> & {
