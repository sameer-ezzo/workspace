...
import { formInput, formScheme, resolveDynamicFormInputsFor, SimpleDataAdapter, Validator } from "@upupa/dynamic-form"
...
export function extractFormScheme(viewModel: Type<any>) {
    ...
    const dynamicFormInputs = resolveDynamicFormInputsFor(viewModel as any)
    return {
        formAttributes: {
