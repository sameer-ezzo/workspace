...
import { DynamicFormComponent, DynamicFormOptionsMetaData } from '@upupa/dynamic-form';
...
export interface DataFormViewModel {
    onSubmit(value: any, e: ActionEvent<any, DataFormViewModelActionContext>): Promise<void> | void;
    validate?(value: any): Promise<null | Record<string, string | null>> | null | Record<string, string | null>;
