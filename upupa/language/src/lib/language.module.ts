...
export class LanguageModule {
    ...
    public static forRoot(defaultLang: string, dictionaries: LanguagesDictionary, routeVariableName = "lang", dictionariesUrl?: string, showLogs = false): ModuleWithProviders<LanguageModule> {
        return {
