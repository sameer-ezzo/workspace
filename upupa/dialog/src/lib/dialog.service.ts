import { Injectable, TemplateRef, Inject, ElementRef, EventEmitter, SimpleChanges, SimpleChange, Signal } from "@angular/core";
...
export type UpupaDialogOutputs = {
    ...
    [outputName: string]: (event: any, context: UpupaDialogActionContext) => Promise<void>;
};
...
export class DialogService {
    ...
    openDialog<P = any, D = any, R = any>(componentOrTemplateRef: ComponentType<P> | TemplateRef<P>, options?: DialogServiceConfig<D>): MatDialogRef<UpupaDialogComponent, R> {
        if (!componentOrTemplateRef) throw new Error("ComponentType is not provided!");
