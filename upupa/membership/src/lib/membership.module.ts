...
import { FORGOT_PASSWORD_EXTERNAL_LINKS_TOKEN, FORGOT_PASSWORD_INITIAL_VALUE_FACTORY_TOKEN, FORGOT_PASSWORD_LINKS_TOKEN, FORGOT_PASSWORD_ON_FAILED_TOKEN, FORGOT_PASSWORD_ON_SUCCESS_TOKEN, FORGOT_PASSWORD_OPTIONS, IdPs_OPTIONS, LOG_IN_EXTERNAL_LINKS_TOKEN, LOG_IN_INITIAL_VALUE_FACTORY_TOKEN, LOG_IN_LINKS_TOKEN, LOG_IN_ON_FAILED_TOKEN, LOG_IN_ON_SUCCESS_TOKEN, LOG_IN_OPTIONS, MEMBERSHIP_OPTIONS, SIGNUP_EXTERNAL_LINKS_TOKEN, SIGNUP_INITIAL_VALUE_FACTORY_TOKEN, SIGNUP_LINKS_TOKEN, SIGNUP_ON_FAILED_TOKEN, SIGNUP_ON_SUCCESS_TOKEN, SIGNUP_OPTIONS, VERIFY_EXTERNAL_LINKS_TOKEN, VERIFY_INITIAL_VALUE_FACTORY_TOKEN, VERIFY_LINKS_TOKEN, VERIFY_ON_FAILED_TOKEN, VERIFY_ON_SUCCESS_TOKEN, VERIFY_OPTIONS } from './di.token';
...
const optionsProviders = <T extends BaseMembershipFormOptions>(form: 'LOG_IN' | 'SIGNUP' | 'FORGOT_PASSWORD' | 'VERIFY', options: T): Provider[] => {
    const providers = {
        'LOG_IN': [
            ...
            { provide: LOG_IN_INITIAL_VALUE_FACTORY_TOKEN, ...options.initial_value_factory },
        ...
        'SIGNUP': [
            ...
            { provide: SIGNUP_INITIAL_VALUE_FACTORY_TOKEN, ...options.initial_value_factory },
            { provide: SIGNUP_LINKS_TOKEN, ...options.links },
            { provide: SIGNUP_EXTERNAL_LINKS_TOKEN, ...options.external_links }
        ],
        'FORGOT_PASSWORD': [
            { provide: FORGOT_PASSWORD_ON_SUCCESS_TOKEN, ...options.on_success },
            { provide: FORGOT_PASSWORD_ON_FAILED_TOKEN, ...options.on_failed },
            { provide: FORGOT_PASSWORD_INITIAL_VALUE_FACTORY_TOKEN, ...options.initial_value_factory },
            { provide: FORGOT_PASSWORD_LINKS_TOKEN, ...options.links },
            { provide: FORGOT_PASSWORD_EXTERNAL_LINKS_TOKEN, ...options.external_links }
        ],
        'VERIFY': [
            { provide: VERIFY_ON_SUCCESS_TOKEN, ...options.on_success },
            { provide: VERIFY_ON_FAILED_TOKEN, ...options.on_failed },
            { provide: VERIFY_INITIAL_VALUE_FACTORY_TOKEN, ...options.initial_value_factory },
...
export class MembershipModule {
    ...
    public static forRoot(options?: MembershipOptions): ModuleWithProviders<MembershipModule> {
