...
export type IdProviderOptions<Name extends IdPName> = Partial<IdPsOptions<Name>> & { on_success?: (instance: any, value: any) => void; on_error?: (instance: any, error: any) => void };
