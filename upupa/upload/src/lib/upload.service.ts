...
export class UploadService {
    ...
    openFileDialog(accept: string = null, multiple = false) {
        return openFileDialog(this.doc, accept, multiple);
    }
}

export function openFileDialog(doc, accept: string = null, multiple = false): Promise<FileList> {
    //not static because that would break arrow functions are designed
